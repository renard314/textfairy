...
public:
	...
	void getTextStatsTiled(Pix* pix, Numa** textSizes);
...
private:
	...
	void numaGroup(Numa* naTextSize, Numa** groupedMean, Numa** groupedStdDev);
	...
	void numaPlot(Numa* numa, Numa* numaExtrema, l_int32 outformat);
