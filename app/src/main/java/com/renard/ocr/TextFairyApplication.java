...
public class TextFairyApplication extends Application {
    ...
    private void loadLibaries() {
        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "c++_shared");

        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "pngo");

        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "jpeg");

        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "lept");

        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "tess");

        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "image_processing");

        ReLinker.log(message -> Log.d("ReLinker", message)).loadLibrary(this, "hocr2pdf");
    }
