...
public class CurlMesh {
	...
	private static final float[] SHADOW_INNER_COLOR = { 0f, 0f, 0f, .25f };
	...
	public CurlMesh(int maxCurlSplits) {
		...
		mRectangle[0].mPenumbraX = mRectangle[1].mPenumbraX = mRectangle[1].mPenumbraY = mRectangle[3].mPenumbraY = -0.5;
		mRectangle[0].mPenumbraY = mRectangle[2].mPenumbraX = mRectangle[2].mPenumbraY = mRectangle[3].mPenumbraX = 0.5;
