...
public class LayoutQuestionDialog {
	...
	public static AlertDialog createDialog(final Context context, final LayoutChoseListener listener) {
...
//        builder = new AlertDialog.Builder(new ContextThemeWrapper(context, R.style.Theme_Sherlock_Light_Dialog));
		...
		final ImageView fairyImage = (ImageView) layout.findViewById(R.id.fairy_image);
		...
		langButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ChooseLanguageDialog.createDialog(context, new ChooseLanguageDialog.OnLanguageChosenListener() {
