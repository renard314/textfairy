...
import com.renard.ocr.CheckableGridElement.OnCheckedChangeListener;
...
public class DocumentAdapter extends CursorAdapter implements OnCheckedChangeListener {
	...
	public DocumentAdapter(DocumentGridActivity activity, int elementLayout, OnCheckedChangeListener listener) {
