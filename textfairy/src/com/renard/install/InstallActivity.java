...
public class InstallActivity extends Activity {
	...
	private Button mButtonStartApp = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mButtonStartApp = (Button) findViewById(R.id.button_start_app);
	...
	static long getTotalUnzippedSize(AssetManager manager) {
		...
		try {
			AssetFileDescriptor fd = manager.openFd(TESSDATA_FILE_NAME);
			ret = fd.getLength();
			if (ret == AssetFileDescriptor.UNKNOWN_LENGTH) {
	...
	public void updateProgress(int progress) {
		...
		final int maxTravelDistance = fairyEndX-fairyStartX;
